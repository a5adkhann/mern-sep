...
const MissionVision = () => {
  return (
    <section
      className="relative py-28 bg-gradient-to-b from-black via-[#0B1120] to-black text-white font-[Michroma] overflow-hidden"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-bold mb-5 bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-500 text-transparent bg-clip-text"
        >
          Our Mission & Vision
        </motion.h2>
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-10">
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-md border border-blue-400/20 rounded-3xl p-8 flex flex-col items-center text-center hover:bg-white/20 transition-all shadow-[0_0_30px_rgba(56,189,248,0.1)]"
          >
            <Target className="text-blue-400 w-14 h-14 mb-4" />
          ...
          <motion.div
            whileHover={{ scale: 1.05 }}
            className="bg-white/10 backdrop-blur-md border border-cyan-400/20 rounded-3xl p-8 flex flex-col items-center text-center hover:bg-white/20 transition-all shadow-[0_0_30px_rgba(14,165,233,0.1)]"
          >
            <Rocket className="text-cyan-400 w-14 h-14 mb-4" />
            <h3 className="text-2xl font-semibold mb-3 text-cyan-400">Our Vision</h3>
            <p className="text-gray-300 text-sm">
          ...
          <motion.div
            whileHover={{ scale: 1.05 }}
            className="bg-white/10 backdrop-blur-md border border-indigo-400/20 rounded-3xl p-8 flex flex-col items-center text-center hover:bg-white/20 transition-all shadow-[0_0_30px_rgba(99,102,241,0.1)]"
          >
            <HeartPulse className="text-indigo-400 w-14 h-14 mb-4" />
            <h3 className="text-2xl font-semibold mb-3 text-indigo-400">Our Core Values</h3>
            <p className="text-gray-300 text-sm">
      ...
      <div className="absolute top-10 left-20 w-72 h-72 bg-blue-400/10 blur-3xl rounded-full"></div>
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-cyan-500/10 blur-3xl rounded-full"></div>
    </section>
  );
};
