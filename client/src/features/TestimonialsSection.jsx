...
const TestimonialCard = ({ testimonial }) => {
  ...
  return (
    <motion.div
      className="relative bg-gradient-to-br from-[#0c0f1f] via-[#13162a] to-black rounded-2xl p-8 shadow-2xl border border-blue-400/20 overflow-hidden w-full h-full"
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <img
              ...
              className="w-14 h-14 rounded-full object-cover ring-2 ring-cyan-400/60"
            />
            <div>
...
const TestimonialsSection = () => {
  ...
  return (
    <section className="relative w-full min-h-screen bg-black flex flex-col justify-center items-center px-6 py-20 font-[Michroma] overflow-hidden">
      {/* Background Orbs */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-cyan-900/10 to-indigo-900/10" />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-400/10 blur-3xl rounded-full animate-pulse" />

      <motion.h2
        initial={{ opacity: 0, y: -30 }}
        whileInView={{ opacity: 1, y: 0 }}
        className="text-5xl md:text-6xl font-bold text-center mb-16 bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-500 bg-clip-text text-transparent z-10"
      >
        Real Feedback
      </motion.h2>
